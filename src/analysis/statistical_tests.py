...
def main():
    ...
    for metric in metrics:
        ...
        if len(systems) == 2:
            ...
            rows.append({"metric":metric,"test":"system_condition_welch_ttest","group_a":systems[0],"group_b":systems[1],
        ...
        for system, sdf in df.groupby("system_condition"):
            for dim in ["gender_condition", "ethnicity_condition", "age_condition"]:
                ...
                if len(groups) == 2:
                    ...
                    rows.append({"metric":metric,"test":f"{system}_{dim}_welch_ttest","group_a":groups[0][0],"group_b":groups[1][0],
